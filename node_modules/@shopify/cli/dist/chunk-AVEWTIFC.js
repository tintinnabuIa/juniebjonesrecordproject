...
async function launchCLI(options) {
  let { errorHandler } = await import("./error-handler-STUDJHBV.js"), { isDevelopment } = await import("./local-SJCC5BYA.js"), oclif = await import("./lib-R4TQWF6K.js"), { ShopifyConfig } = await import("./custom-oclif-loader-MKZUUH3S.js");
...
async function exitIfOldNodeVersion(versions = process.versions) {
  ...
  if (nodeMajorVersion < 18) {
    let { renderError } = await import("./ui-ER5WOAGG.js");
    renderError({
...
async function addInitToArgvWhenRunningCreateCLI(options, argv = process.argv) {
  let { findUpAndReadPackageJson } = await import("./node-package-manager-2L2NJGLS.js"), { moduleDirectory } = await import("./path-H3TILUQU.js"), name = (await findUpAndReadPackageJson(moduleDirectory(options.moduleURL))).content.name.replace("@shopify/create-", "");
...
//# sourceMappingURL=chunk-AVEWTIFC.js.map
